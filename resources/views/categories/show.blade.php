            ...
            <div class="col">
              <div class="card card-plain h-100">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 text-end">
                      <a href="{{ route('categories.edit',$categories->id) }}">
                        <i class="fas fa-user-edit text-secondary text-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit category details"></i>
                      </a>
                    </div>
                  </div>
                </div>
                <div class="card-body p-3">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Category Name:</strong> &nbsp; {{$categories->name}}</li>
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Description:</strong> &nbsp; {{$categories->description}}</li>
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Courses available:</strong> &nbsp;
                        <ol>
