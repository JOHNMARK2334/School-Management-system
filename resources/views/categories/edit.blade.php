            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Edit category details</h4>
                </div>
              </div>
              @if ($errors->any())
              ...
              <div class="card-body">
                    <div class="container fluid">
                        ...
                        <form action="{{ route('categories.update') }}" method="POST" class="text-start" enctype="multipart/form-data">
                            ...
                            @method('PUT')
                            <div class="row">
                            <input type="text" name="id" id="id" class="form-control" value="{{$categories->id}}" hidden>
                            ...
                            <div class="input-group input-group-outline my-3">
                                ...
                                <textarea type="text" name="description" id="description" class="form-control" rows="4" cols="4"required>{{$categories->description}}</textarea>
                                @error('description')
                                <div class="alert alert-danger mt-1 mb-1">
                                    {{ $message }}
                                </div>
