            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Edit department details</h4>
                </div>
              </div>
              @if ($errors->any())
              ...
              <div class="card-body">
                    <div class="container fluid">
                        ...
                        <form action="{{ route('departments.update') }}" method="POST" role="form" class="text-start" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                            <input type="text" name="id" id="id" class="form-control" value="{{$departments->id}}" hidden>
                            <div class="input-group input-group-outline my-3">
                                <strong>Name:</strong>
                                <input type="text" name="name" id="name" class="form-control" value="{{$departments->name}}" required>
                                @error('name')
                            ...
                            <div class="input-group input-group-outline my-3">
                                ...
                                <input type="text" name="short_name" id="short_name" class="form-control" value="{{$departments->short_name}}"required>
                                @error('short_name')
                                <div class="alert alert-danger mt-1 mb-1">
                                    {{ $message }}
                                </div>
