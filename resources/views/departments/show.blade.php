            ...
            <div class="col">
              <div class="card card-plain h-100">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 text-end">
                      <a href="{{ route('departments.edit',$departments->id) }}">
                        <i class="fas fa-user-edit text-secondary text-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit department details"></i>
                      </a>
                    </div>
                  </div>
                </div>
                <div class="card-body p-3">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Full Name:</strong> &nbsp; {{$departments->name}}</li>
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Reference name:</strong> &nbsp; {{$departments->short_name}}</li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Department head:</strong> &nbsp; {{$departments->department_head}}</li>
                    <div class="pull-right">
                        <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Description:</strong> &nbsp; {{$departments->description}}</li>
                    </div>
