            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    ...
                    <div style="position:absolute; right:0;">
                        <a class="btn btn-secondary" href="{{ route('departments.create') }}">Add new department</a>
                    </div>
                </div>
            </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href ="{{ route('departments.delete',$department->id) }}" class="btn btn-warning">Delete</a>
                        </td>
                        <td></td>
                    </tr>
                    @endforeach
