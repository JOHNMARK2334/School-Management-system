            ...
            <div class="col">
              <div class="card card-plain h-100">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 text-end">
                      <a href="{{ route('roles.edit',$roles->id) }}">
                        <i class="fas fa-user-edit text-secondary text-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit role details"></i>
                      </a>
                    </div>
                  </div>
                </div>
                <div class="card-body p-3">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Role Name:</strong> &nbsp; {{$roles->name}}</li>
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Reference name:</strong> &nbsp; {{$roles->short_name}}</li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Description:</strong> &nbsp; {{$roles->description}}</li>
                    <div class="pull-right">
                        <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Department:</strong> &nbsp; {{\App\Models\Department::query()->where('id',$roles->department_id)->first()->name}}</li>
                    </div>
                  </ul>
                </div>
              </div>
