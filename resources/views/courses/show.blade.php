            ...
            <div class="col">
              <div class="card card-plain h-100">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 text-end">
                      <a href="{{ route('courses.edit',$courses->id) }}">
                        <i class="fas fa-user-edit text-secondary text-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit course details"></i>
                      </a>
                    </div>
                  </div>
                </div>
                <div class="card-body p-3">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Course Name:</strong> &nbsp; {{$courses->name}}</li>
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Reference Name:</strong> &nbsp; {{$courses->short_name}}</li>
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Course number:</strong> &nbsp; {{$courses->number}}</li>
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Duration:</strong> &nbsp; {{$courses->duration}}</li>
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Description:</strong> &nbsp; {{$courses->description}}</li>
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Department:</strong> &nbsp; {{\App\Models\Department::query()->where('id',$courses->department_id)->first()->name}}</li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Category:</strong> &nbsp; {{\App\Models\Category::query()->where('id',$courses->category_id)->first()->name}}</li>
                  </ul>
                </div>
              </div>
            </div>
