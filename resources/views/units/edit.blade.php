            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                    <div class="container fluid">
                        Edit staff details:
                        <form action="{{ route('units.update') }}" method="POST" role="form" class="text-start" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                            <input type="text" name="id" id="id" class="form-control" value="{{$units->id}}" hidden>
                            <div class="input-group input-group-outline my-3">
                                <strong>Name:</strong>
                                <input type="text" name="name" id="name" class="form-control" value="{{$units->name}}" required>
                                @error('name')
                            ...
                            <div class="input-group input-group-outline my-3">
                                ...
                                <input type="text" name="description" id="description" class="form-control" value="{{$units->description}}"required>
                                @error('description')
                                <div class="alert alert-danger mt-1 mb-1">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="input-group input-group-outline my-3">
                                <strong>Year:</strong>
                                <input type="number" name="year" id="year" class="form-control" value="{{$units->year}}" required>
                                @error('year')
                                <div class="alert alert-danger mt-1 mb-1">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="input-group input-group-outline my-3">
                                ...
                                <input type="number" name="semester" id="semester" class="form-control" value="{{$units->semester}}" required>
                                @error('semester')
                                <div class="alert alert-danger mt-1 mb-1">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="input-group">
                              ...
                              <select class="form-select" data-placeholder="Select a  course" style="width:50%" name="course_id" value="{{\App\Models\Course::query()->where('id',$units->course_id)->first()->name}}">
