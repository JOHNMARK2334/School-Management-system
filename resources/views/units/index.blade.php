      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Units</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Units</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Units table</h6>
                <div style="position:absolute; right:0;">
                  <a class="btn btn-secondary" href="{{ route('units.create') }}">Add new unit</a>
                </div>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0 table-bordered">
                  <thead>
                    <tr>
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Unit code</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$unit->semester}}</td>
                      <td>
                        <a href="{{ route('units.show',$unit->id) }}" class="btn btn-success">View</a>
                        <a href="{{route('units.edit',$unit->id) }}" class="btn btn-info">Edit</a>
                        <a href ="{{ route('units.delete',$unit->id) }}" class="btn btn-warning">Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://github.com/JOHNMARK2334" class="font-weight-bold" target="_blank">JOHNMARK</a>
                for a better web.
              </div>
            </div>
            <div class="col-lg-6">
              <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                <li class="nav-item">
                  <a href="https://github.com/JOHNMARK2334" class="nav-link text-muted" target="_blank">Creative Tim</a>
                </li>
                <li class="nav-item">
                  <a href="https://github.com/JOHNMARK2334" class="nav-link text-muted" target="_blank">About Us</a>
                </li>
                <li class="nav-item">
                  <a href="https://github.com/JOHNMARK2334" class="nav-link text-muted" target="_blank">Blog</a>
                </li>
                <li class="nav-item">
                  <a href="https://github.com/JOHNMARK2334" class="nav-link pe-0 text-muted" target="_blank">License</a>
                </li>
              </ul>
            </div>
          </div>
