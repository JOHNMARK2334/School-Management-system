            ...
            <div class="col">
              <div class="card card-plain h-100">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 text-end">
                      <a href="{{ route('units.edit',$units->id) }}">
                        <i class="fas fa-user-edit text-secondary text-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit unit details"></i>
                      </a>
                    </div>
                  </div>
                </div>
                <div class="card-body p-3">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Unit Name:</strong> &nbsp; {{$units->name}}</li>
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Description:</strong> &nbsp; {{$units->description}}</li>
                    <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Course:</strong> &nbsp; {{\App\Models\Course::query()->where('id',$units->course_id)->first()->name}}</li>
                    <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Year:</strong> &nbsp; {{$units->year}}</li>
                    <div class="pull-right">
                        <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Semester:</strong> &nbsp; {{$units->semester}}</li>
                    </div>
                  </ul>
                </div>
              </div>
