            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    ...
                    <div style="position:absolute; right:0;">
                        <a class="btn btn-secondary" href="{{ route('staff.create') }}">Add new Staff Member</a>
                    </div>
                </div>
            </div>
              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td>{{$staff->id}}</td>
                        <td><img src="{{ asset('public/Image/'.$staff->photo)}}" class="rounded-circle" width="60px" height="60px" alt=""/></td>
                        <td>{{ $staff->name}}</td>
                        <td>{{ $staff->email}}</td>
                        <td>{{ $staff->phone_number }}</td>
                        <td>
                            <a href="{{ route('staff.show',$staff->id) }}" class="btn btn-success">View</a>
                            <a href="{{route('staff.edit',$staff->id) }}" class="btn btn-info">Edit</a>
                            <a href ="{{ route('staff.delete',$staff->id) }}" class="btn btn-warning">Delete</a>
                        </td>
                        <td></td>
                    </tr>
                    @endforeach
