          ...
          <div class="col-auto my-auto">
            <div class="h-100">
              ...
              <p class="mb-0 font-weight-normal text-sm">
                {{\App\Models\Course::query()->where('course_id',$students->course_id)->first()->name}}
              </p>
            </div>
          </div>
            ...
            <div class="col">
              <div class="card card-plain h-100">
                ...
                <div class="card-body p-3">
                  <p class="text-sm">
                    A student in {{\App\Models\Course::query()->where('course_id',$students->course_id)->first()->description}}
                  </p>
