        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank" href="https://github.com/JOHNMARK2334/School-Management-system">Online Builder</a>
            </li>
            <li class="mt-2">
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                ...
                <div style="position:absolute; right:0;">
                  <a class="btn btn-secondary" href="{{ route('students.create') }}">Add new Student</a>
                </div>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0 atble-bordered">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Admission year</th>
